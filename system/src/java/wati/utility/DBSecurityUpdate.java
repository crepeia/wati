...
public class DBSecurityUpdate {
    ...
    public static void run(){
        ...
        em = Persistence.createEntityManagerFactory("watiPU").createEntityManager();
        Logger.getLogger(DBSecurityUpdate.class.getName()).log(Level.INFO, "Running DBSecurityUpdate");
        List<User> users = em.createQuery("SELECT u FROM User u where u.password is not null and app_signup=0", User.class).getResultList();
