Introduction
----------------
This repository hosts the Live without tobacco ("Viva sem Tabaco") project, the first open-source web-assisted tobacco intervention. The intervention content is adapted from the widely accepted guidelines *Treating Tobacco Use and Dependence* (U.S Departament of Health and Human Services).
...
Translation
----------------
If you're interested in helping smokers in your language, you can start translating Live without tobacco now. It is quite easy! You only need to access our page at crowdin https://crowdin.com/project/livewithouttobacco.
