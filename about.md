...
* Open-source! We just love free software - Almost content built using free software (even the graphics and animations).
* Compability with older browers and not so big screen resolutions (pretty common in developing countries).
...
## Who pays the bill?
For now, all funding comes from research agencies in Brazil. We are really thankfull for FAPEMIG, CAPES and CNPq.
